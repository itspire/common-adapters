...
namespace Itspire\Common\Adapter\Tests\Unit\Dao\Enum;
...
class EnumDaoAdapterTest extends TestCase
{
    ...
    public function adaptBusinessToDaoWithUnsupportedClassTest(): void
    {
        ...
        $this->expectExceptionMessage(
            sprintf('Adapter %s does not support %s class', EnumDaoAdapter::class, DummyEnum::class)
        );

        $this->enumDaoAdapter->adaptBusinessToDao(new DummyEnum(BusinessEnum::TEST));
    }
